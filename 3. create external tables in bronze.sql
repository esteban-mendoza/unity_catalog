...
USING json
OPTIONS (path "abfss://bronze@unitycatalogextsa.dfs.core.windows.net/drivers.json");
...
USING json
OPTIONS (path "abfss://bronze@unitycatalogextsa.dfs.core.windows.net/results.json");
